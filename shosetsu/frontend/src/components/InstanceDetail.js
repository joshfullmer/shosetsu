...
export default class InstanceDetail extends Component {
  ...
  componentDidMount() {
    axios.get(`http://127.0.0.1:8000/api/project/${this.state.project_id}/element/${this.state.element_id}/instance/${this.state.instance.id}/`)
      .then(response => {
        this.setState({
    ...
    axios.get(`http://127.0.0.1:8000/api/project/${this.state.project_id}/element/${this.state.element_id}/field/`)
      .then(response => {
        this.setState({
